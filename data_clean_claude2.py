...
SEASONS = ['pbp_2024_25_regularseason', 'pbp_2023_24_regularseason', 'pbp_2022_23_regularseason']
ELO_FILE = os.path.join(BASE_DIR, 'nba_elo.csv')
OUTPUT_FILE = os.path.join(BASE_DIR, 'combined_pbp_all_seasons2.csv')
EXISTING_PARTIAL_FILE = os.path.join(BASE_DIR, 'combined_pbp_all_seasons2_progress.csv')
